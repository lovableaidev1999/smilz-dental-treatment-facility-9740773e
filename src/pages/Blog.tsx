...
const CATEGORIES = [
  ...
  { slug: "dental-implant", label: "Dental Implants" },
  { slug: "orthodontics", label: "Orthodontics" },
  { slug: "rct", label: "Root Canal" },
  { slug: "caries", label: "Caries" },
  { slug: "emergency", label: "Emergency" },
];

const Blog = () => {
  const [activeCategory, setActiveCategory] = useState("");
  const { data: posts, isLoading } = useBlogPosts(activeCategory || undefined);
