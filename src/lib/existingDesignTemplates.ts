...
function serviceDetailDesign(): LayoutNode[] {
  return [
    ...
    {
      id: genId(), type: 'section',
      props: { background: '', maxWidth: '1280px', fullWidth: false, gridColumns: '2fr 1fr', columnGap: '3rem', rowGap: '1.5rem', locked: true, spacing: 'medium' },
    ...
    {
      id: genId(), type: 'section',
      props: { background: 'hsl(var(--primary))', maxWidth: '1280px', fullWidth: true, gridColumns: '1fr', columnGap: '1.5rem', rowGap: '1.5rem', locked: true, spacing: 'medium' },
